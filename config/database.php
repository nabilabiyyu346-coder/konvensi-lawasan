...
try {
    ...
    die('Koneksi basis data gagal. Pastikan MySQL aktif dan database "toko_batik" sudah diimport dari database/schema.sql. Detail: ' . $e->getMessage());
}
